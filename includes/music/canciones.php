...
<?php
    ...
    while ($fila = $resultado->fetchArray()) {
        echo
         '<tr>
            <td><a href="music.php?page=1&song='.$fila['c_idcancion'].'"><div>'.$fila['c_nombre'].' (reproducir)</div></a></td>
            ...
            <td><a href ="php/music/eliminarcancion.php?idcancion='.$fila['c_idcancion'].'">Eliminar</a></td>
         </tr>';
    }
