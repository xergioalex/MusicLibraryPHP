...
echo '<div id="divtablas">';
    ...
    while($fila = sqlite_fetch_array($resultado)){
         echo 
         '<tr>
            <td><a href="music.php?page=1&song='.$fila['c.idcancion'].'"><div>'.$fila['c.nombre'].'</div></a></td>
            ...
            <td><a href ="php/music/eliminarcancion.php?idcancion='.$fila['c.idcancion'].'">Eliminar</a></td>
         </tr>';
    }
